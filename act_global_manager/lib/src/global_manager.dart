...
abstract class GlobalManager {
  ...
  late LoggerManager _defaultLogger;
  ...
  @protected
  void registerSingletonAsync<T extends AbstractManager>(ManagerBuilder<T> builder) {
  ...
  void init() {
    ...
    Future<LoggerManager> loggerFactory() async {
      final loggerManager = await loggerBuilder.asyncFactory();

      GlobalManager.instance!._defaultLogger = loggerManager;
