  ...
  static TextSpan highlightText(
    ...
    TextStyle? highLightTextStyle,
      ...
      highlightTextMultiple(text, [wordToHighlight],
          ...
          highLightTextStyles: (highLightTextStyle != null)
              ? {
  ...
  static TextSpan highlightTextMultiple(
    ...
    for (final interval in intervals) {
      textSpans.add(TextSpan(
        ...
        style: (interval.key != null) ? highLightTextStyles[interval.key] : null,
      ));
    }
  ...
  static List<_TextInterval> _flatIntervals(
    ...
    for (var index = 0; index < text.length; index++) {
      ...
      for (var keyIdx = (tmpKeys.length - 1); keyIdx >= 0; keyIdx--) {
        ...
        final tmpInter = intervalsToFlat[key] as List<_TextInterval>;
