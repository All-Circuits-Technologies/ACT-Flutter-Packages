...
//
// SPDX-License-Identifier: LicenseRef-FlutterProjectAuthors

// This is a problem of the elements retrieved from flutter
// ignore_for_file: prefer_asserts_with_message

// This is file is a copy of
// https://github.com/bleroux/flutter/blob/master/packages/flutter/lib/src/material/dropdown_menu_form_field.dart
// TODO(brolandeau): remove the file when the dropdown_menu_form_field is merged on flutter stable branch
...
class _DropdownMenuFormFieldState<T> extends FormFieldState<T> {
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    if (_restorableController != null) {
      ...
      final matchingValue = _findValueByLabel(_restorableController!.value.text);
  ...
  T? _findValueByLabel(String label) {
    for (final entry in _dropdownMenuFormField.dropdownMenuEntries) {
