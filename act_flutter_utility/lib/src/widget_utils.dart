...
class WidgetUtils {
  ...
  static double getSizeWithFactor(
          double sizeElement, double factorOfSizeElem) =>
  ...
  /// itself.
  static bool isGlobalPositionOverWidget(
      Offset position, GlobalKey widgetGlobalKey) {
