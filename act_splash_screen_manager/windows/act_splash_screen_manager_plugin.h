...
namespace act_splash_screen_manager
{
    ...
    class ActSplashScreenManagerPlugin : public flutter::Plugin
    {
      public:
        /**
        ...
        ~ActSplashScreenManagerPlugin() override;

        ActSplashScreenManagerPlugin(const ActSplashScreenManagerPlugin &) = delete;
        ActSplashScreenManagerPlugin &operator=(
            const ActSplashScreenManagerPlugin &) = delete;
