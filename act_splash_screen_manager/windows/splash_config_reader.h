...
#ifndef ACT_SPLASH_SCREEN_WINDOWS_SPLASH_CONFIG_READER_H_
#define ACT_SPLASH_SCREEN_WINDOWS_SPLASH_CONFIG_READER_H_

/// @file splash_config_reader.h
/// @brief Reads the splash screen configuration from the assets bundled with a Windows application.
...
namespace act_splash_screen
{
    ...
    /**
     * @brief Turns a path of the configuration into a path of the platform.
     *
     * @param path Path as the configuration writes it, with forward slashes.
     * @return The same path with the separators of the platform.
     */
     ...
     *
     * What is wrong in it is written where the application writes.
     *
...
#endif // ACT_SPLASH_SCREEN_WINDOWS_SPLASH_CONFIG_READER_H_
