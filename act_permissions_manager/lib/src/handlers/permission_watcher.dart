...
class PermissionWatcher extends SharedWatcher<PermissionHandler> {
  ...
  final StreamController<permission_handler.PermissionStatus>
      _currentStatusCtrl;
  ...
  StreamController<permission_handler.PermissionStatus> get currentStatusCtrl =>
      _currentStatusCtrl;

  /// Get the current [permission_handler.PermissionStatus]
  Future<permission_handler.PermissionStatus> get status =>
      _permissionMutex.protectRead(() async {
  ...
  Future<bool> shouldShowRationale() => _permissionMutex.protectWrite(() async {
        ...
        // method
        return _permissionsManager.shouldShowRationale(element);
      });
  ...
  Future<permission_handler.PermissionStatus> requestPermission({
    bool checkRationale = false,
      ...
      _permissionMutex.protectWrite(() async {
        // The set to current status is already done in the request permission
        // method
        return _permissionsManager.requestPermission(
          element,
