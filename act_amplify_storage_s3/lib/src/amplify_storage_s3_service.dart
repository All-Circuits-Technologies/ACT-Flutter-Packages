...
/// [MixinStorageService] therefore it can be used with the [AbsStorageManager] which provides
/// an optionnal cache system.
class AmplifyStorageS3Service extends AbsAmplifyService with MixinStorageService {
  ...
  static StorageRequestResult _parseExeption(Exception e) {
