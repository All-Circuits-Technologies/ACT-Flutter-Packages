...
class LogsHelper {
  ...
  /// Log a message at level [Level.verbose], this is an alias of the [LoggerManager] method to add
  /// category in it
  void v(dynamic message, [dynamic error, StackTrace? stackTrace]) =>
      logsManager.v(message, logsCategory, error, stackTrace);
  ...
  /// Log a message at level [Level.wtf], this is an alias of the [LoggerManager] method to add
  /// category in it
  void wtf(dynamic message, [dynamic error, StackTrace? stackTrace]) =>
      logsManager.wtf(message, logsCategory, error, stackTrace);
