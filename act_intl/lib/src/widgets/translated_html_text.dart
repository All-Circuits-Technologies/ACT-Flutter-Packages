...
class _TranslatedHtmlTextState extends State<TranslatedHtmlText> {
  ...
  Future<void> loadTxtFile(BuildContext context) async {
    String translated = await IntlFileUtility.loadTransAssetFileText(
      context,
      widget.textPath,
    );
  ...
  Widget build(BuildContext context) {
    ...
    // TODO The text scaling problem and the right overflow is currently fixing
    // TODO in the flutter_html package: https://github.com/Sub6Resources/flutter_html/issues/308
