...
class TicManager extends AbstractManager {
  ...
  /// when nobody listen.
  final TicGenerator _ticGen500ms =
      TicGenerator(const Duration(milliseconds: 500));
...
class TicModulo {
  ...
  TicModulo(this.source, this.modulo) : assert(modulo > 1) {
