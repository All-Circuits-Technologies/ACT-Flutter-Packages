...
sealed class HttpResponseUtility {
  ...
  /// The method tests if the status of the http response is ok (no problem occurred in the process)
  static bool isStatusOk(AWSHttpResponse response) => response.statusCode == HttpStatus.ok;
}
