...
typedef double GetDurationFactor(int occurrenceNth);
...
class ProgressingRestartableTimer implements Timer {
  ...
  })  : assert(initDuration != null),
        assert(factorCallback != null) {
  ...
  ProgressingRestartableTimer.expFactor(
    ...
    bool waitNextResetToStart = false,
        ...
        this.factorCallback = getExponentialFactor {
    _init(waitNextResetToStart);
  }
  ...
  ProgressingRestartableTimer.logFactor(
    ...
    bool waitNextResetToStart = false,
        ...
        this.factorCallback = getLogFactor {
    _init(waitNextResetToStart);
  }
  ...
  ProgressingRestartableTimer.simpleFactor(
    ...
    bool waitNextResetToStart = false,
        ...
        this.factorCallback = getSimpleFactor {
    _init(waitNextResetToStart);
  }
  ...
  ProgressingRestartableTimer.noneFactor(
    ...
    bool waitNextResetToStart = false,
        ...
        this.factorCallback = getNoneFactor {
    _init(waitNextResetToStart);
  }
  ...
  Duration _getDuration(int occurrence) {
    Duration duration = initDuration * factorCallback(occurrence);
