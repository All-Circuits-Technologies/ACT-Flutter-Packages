...
/// This class provides a way for the application to force a [ConsentService] to attempt to load
/// all the consent information when a value we listen to changes from being evaluated as invalid to
/// valid.
abstract class ConsentObserver<T> {
