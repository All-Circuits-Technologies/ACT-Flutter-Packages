...
mixin MixinAuthRedirectService<T extends MixinAuthRoute>
  ...
  Future<bool> initRedirectService() async {
    ...
    _authSub =
        _authManager.authService.authStatusStream.listen(_onNewAuthStatus);
  ...
  @override
  Future<T?> onRedirect(
      BuildContext context, T route, GoRouterState state) async {
