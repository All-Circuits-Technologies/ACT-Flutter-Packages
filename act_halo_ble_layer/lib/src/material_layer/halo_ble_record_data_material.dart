...
/// This is the BLE material layer for managing record data
class HaloBleRecordDataMaterial extends AbstractHaloRecordDataMaterial {
  /// Class constructor
  HaloBleRecordDataMaterial({
