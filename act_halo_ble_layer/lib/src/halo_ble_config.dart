...
/// Contains all the needed configuration for the HALO BLE material layer
  ...
  HaloBleConfig({
    ...
    required this.maxCharacteristicByteSize,
        ...
        charJRequestToDeviceCmd =
            CharJRequestToDeviceCmd(uuid: charJRequestToDeviceCmdUuid.uuid),
        charKRequestToDeviceTmp =
            CharKRequestToDeviceTmp(uuid: charKRequestToDeviceTmpUuid.uuid),
        charLRequestToClientCmd =
            CharLRequestToClientCmd(uuid: charLRequestToClientCmdUuid.uuid),
        charMRequestToClientTmp =
            CharMRequestToClientTmp(uuid: charMRequestToClientTmpUuid.uuid) {
