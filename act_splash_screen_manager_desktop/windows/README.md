...
# ACT Splash screen desktop - Windows  <!-- omit from toc -->
...
| `act_splash_screen_manager_desktop_plugin.{h,cpp}` | the Flutter plugin, which turns the `hide` call of the application into `ActSplashScreenHide` |
...
> build\windows\x64\plugins\act_splash_screen_manager_desktop\Debug\act_splash_screen_manager_desktop_test.exe
```
