...
namespace act_splash_screen_manager_desktop
{
    ...
    void ActSplashScreenManagerDesktopPlugin::RegisterWithRegistrar(
        flutter::PluginRegistrarWindows *registrar)
    {
        auto channel = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
            registrar->messenger(), kChannelName, &flutter::StandardMethodCodec::GetInstance());

        auto plugin = std::make_unique<ActSplashScreenManagerDesktopPlugin>();
    ...
    ActSplashScreenManagerDesktopPlugin::ActSplashScreenManagerDesktopPlugin()
    {
    }
    ...
    void ActSplashScreenManagerDesktopPlugin::handleMethodCall(
