...
typedef struct _ActSplashScreenManagerDesktopPlugin ActSplashScreenManagerDesktopPlugin;
typedef struct
{
    GObjectClass parent_class;
} ActSplashScreenManagerDesktopPluginClass;

/// @brief Returns the GType of the plugin, declared by G_DEFINE_TYPE.
FLUTTER_PLUGIN_EXPORT GType act_splash_screen_manager_desktop_plugin_get_type();
 ...
 */
FLUTTER_PLUGIN_EXPORT void act_splash_screen_manager_desktop_plugin_register_with_registrar(
