...
# ACT Splash screen desktop - Linux  <!-- omit from toc -->
...
| `act_splash_screen_manager_desktop_plugin.cc` | the Flutter plugin, which turns the `hide` call of the application into `act_splash_screen_hide` |
