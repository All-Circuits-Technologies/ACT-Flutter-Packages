...
class CognitoPasswordService extends AbstractService {
  ...
  static AuthResetPwdStatus _parseException(AuthException exception) {
    if (exception is NetworkException) {
      return AuthResetPwdStatus.networkError;
    }

    if (exception is InvalidPasswordException) {
      return AuthResetPwdStatus.newPasswordNotConform;
    }

    return AuthResetPwdStatus.genericError;
  }
}
