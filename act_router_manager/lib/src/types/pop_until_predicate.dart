...
/// Result of the [PopUntilPredicate] method
enum PopUntilAction {
  /// This means we can continue to pop (if there is view to pop)
  continueRemoving(isFinished: false),

  /// This means we have nothing more to do (no need to pop); this may happen if the
  /// current page is already the page we want to reach.
  nothingMoreToDo;
...
typedef PopUntilPredicate = PopUntilAction Function(String currentRoutePath);
