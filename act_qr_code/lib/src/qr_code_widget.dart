...
class _QrCodeWidgetState extends State<QrCodeWidget> {
  ...
  Future<void> onMatchedDataFound(BuildContext blocContext, String scanData) async {
    ...
    BlocProvider.of<QrCodeBloc>(blocContext).add(const QrCodeFoundEvent(found: true));
