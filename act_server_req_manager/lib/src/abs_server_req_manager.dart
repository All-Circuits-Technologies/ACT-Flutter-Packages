...
abstract class AbsServerReqBuilder<T extends AbsServerReqManager> extends ManagerBuilder<T> {
  /// Class constructor
...
abstract class AbsServerReqManager<T extends AbsServerLogin?> extends AbstractManager {
