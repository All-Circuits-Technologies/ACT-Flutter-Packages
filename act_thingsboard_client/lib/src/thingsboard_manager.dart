...
class ThingsboardBuilder<E extends MixinThingsboardEnv,
        S extends MixinThingsboardSecret>
...
class ThingsboardManager<E extends MixinThingsboardEnv,
    S extends MixinThingsboardSecret> extends AbstractManager {
  ...
  Future<void> initManager() async {
    ...
    devicesService = TbDevicesService(
        requestService: _requestService, logsHelper: _logsHelper);
