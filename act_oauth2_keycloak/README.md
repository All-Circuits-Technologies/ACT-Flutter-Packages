...
itself, `act_oauth2_core` builds `<scheme>:/oauthredirect`, with a single slash, out of the scheme
the configuration names. A Keycloak client validates the redirect URI it receives
