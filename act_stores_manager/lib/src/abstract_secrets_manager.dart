...
abstract class AbstractSecretsManager<P extends AbstractPropertiesManager,
    E extends MixinStoresEnv> extends AbstractManager {
  ...
  Future<void> initManager() async {
    ...
    final isNeededToDeleteAll =
        globalGetIt().get<E>().cleanSecretStorageWhenReinstall.load();
