...
abstract class AbstractSecretsBuilder<P extends AbstractPropertiesManager, E extends MixinStoresEnv,
    T extends AbstractSecretsManager<P, E>> extends ManagerBuilder<T> {
...
abstract class AbstractSecretsManager<P extends AbstractPropertiesManager, E extends MixinStoresEnv>
