...
mixin MixinWebsocketServerConfig on AbstractConfigManager {
  ...
  final wsServerPort = const ConfigVar<int>("webSocket.server.port");

  /// This is the ports range to use when we create the WebSocket server
  ///
  /// If [wsServerPort] is set, it will be used as the only port in the range.
