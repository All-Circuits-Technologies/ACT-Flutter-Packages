...
mixin MixinTbTelemetriesUiBloc<NewStateEvent extends Event, Event, State> on Bloc<Event, State> {
  ...
  @protected
  void constructTbTelemUiBloc<Ca extends MixinTelemetriesKeys, Sha extends MixinTelemetriesKeys,
  ...
  void constructTbTelemUiBlocWithDeviceInfoFromName<
    ...
    List<Ts> timeSeriesKeys = const [],
      ...
      constructTbTelemUiBloc(
        getDeviceInfo: () async =>
            globalGetIt().get<ThingsboardManager>().devicesService.getCustomerDeviceByName(
  ...
  void _onNewTelemetriesUiState(TbTelemetriesUiState telemetriesUiState) {
    ...
    switch (telemetriesUiState.runtimeType) {
      case TbAttributesNewValuesUiState:
        type = TbTelemetryUiStateType.newAttributes;
        break;
      case TbTimeSeriesNewValuesUiState:
  ...
  void addRetryTbTelemetriesInit() => _telemetriesBloc.add(const RetryInitTbTelemetriesUiEvent());
