...
/// has changed
mixin MixinTbTelemetriesUiState on AbstractActBlocElement {
  ...
  TbTelemetriesUiError get tbTelemetriesGenericError =>
      telemetriesUiState.genericError;
  ...
  void constructTbTelemetriesUiState({
    ...
    this.telemetriesUiState =
        telemetriesUiState ?? previousState.telemetriesUiState;
  }
  ...
  T? getTsValue<T>(MixinTelemetriesKeys key) =>
      telemetriesUiState.getTsValue(key);
  ...
  T? getAttributeValue<T>(MixinTelemetriesKeys key) =>
      telemetriesUiState.getAttributeValue(key);
