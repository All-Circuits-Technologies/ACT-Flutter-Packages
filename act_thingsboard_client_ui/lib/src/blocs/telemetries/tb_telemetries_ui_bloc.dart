...
class TbTelemetriesUiBloc<
    ...
    Ts extends MixinTelemetriesKeys> extends Bloc<TbTelemetriesUiEvent, TbTelemetriesUiState> {
  ...
  Future<bool> _manageInternetConnectivity() async {
    ...
    _internetSub ??= internetManager.hasConnectionStream.listen(_onInternetUpdate);
