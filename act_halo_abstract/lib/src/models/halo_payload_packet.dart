...
class HaloPayloadPacket {
  ...
  List<Uint8List> getDataToSend({
    ...
    return HaloPacketUtility.formatPackets(
  ...
  /// the list length) the method returns null
  /// If a timestamp is attached to the element, it will be returned
  (int, DateTime?)? getUInt(int elemIdx) {
    return getNumber(elemIdx, false);
  }
  ...
  /// the list length) the method returns null
  /// If a timestamp is attached to the element, it will be returned
  (int, DateTime?)? getInt(int elemIdx) {
    return getNumber(elemIdx, true);
  }
