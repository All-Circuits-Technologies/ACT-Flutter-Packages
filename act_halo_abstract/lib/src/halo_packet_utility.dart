...
abstract class HaloPacketUtility {
  ...
  static PayloadPacketElem formatString(
    ...
    return _formatAndEscapePacketElem(Uint8List.fromList(toSend.codeUnits), ts);
  }
  ...
  static PayloadPacketElem? formatUInt8(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt8, false, ts: ts);
  }
  ...
  static PayloadPacketElem? formatUInt16(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt16, false, ts: ts);
  }
  ...
  static PayloadPacketElem? formatUInt32(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt32, false, ts: ts);
  }
  ...
  static PayloadPacketElem? formatInt8(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt8, true, ts: ts);
  }
  ...
  static PayloadPacketElem? formatInt16(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt16, true, ts: ts);
  }
  ...
  static PayloadPacketElem? formatInt32(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt32, true, ts: ts);
  }
  ...
  static PayloadPacketElem? formatInt64(
    ...
    return HaloPacketUtility._formatNumber(number, ByteUtility.bytesNbUInt64, true, ts: ts);
  }
  ...
  static bool? isLastElementPacket(Uint8List packet) {
    ...
    if (packet.contains(HaloPacketUtility._endByte)) {
      appLogger().w("The end byte has been seen in the packet received but this should never "
