...
/// This defines an abstract class for the instant data part of the material layer
abstract class AbstractHaloInstantDataMaterial
  ...
  Stream<HaloPacket> get instDataNewValueStream =>
      _instantDataNewValueCtrl.stream;

  /// This allows the derived classes to send updated instant data values to upper classes
  @protected
  StreamController<HaloPacket> get instantDataNewValueCtrl =>
      _instantDataNewValueCtrl;

  /// Class constructor
  AbstractHaloInstantDataMaterial()
  ...
  /// [HaloDataId] given
  Future<(HaloErrorType, HaloPacket?)> readInstantData(
